...
\title{
    Modelling the travel time of rtansit vehicles in \rt through a GTFS-based road network
...
although attempts were made at generalising each component so 
it will be compatible with other public transport systems around the world.
