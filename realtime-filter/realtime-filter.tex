...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
\subfloat[Stop\label{fig:likelihood_circles1}]{\includegraphics[width=0.5\linewidth]{figure/likelihood_circles-1} }
\subfloat[Intersection\label{fig:likelihood_circles2}]{\includegraphics[width=0.5\linewidth]{figure/likelihood_circles-2} }\caption[Likelihood functions for particle's at stops and intersections]{Likelihood functions for particle's at stops and intersections. The grey region represents the area where particle's are accepted.}\label{fig:likelihood_circles}
\end{figure}
